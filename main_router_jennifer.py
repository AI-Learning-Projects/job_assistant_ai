...
from job_prompts import PROMPT_INFO, MULTI_PROMPT_ROUTER_TEMPLATE
...
"""
This code iterates through the `PROMPT_INFO` list and creates a dictionary of `LLMChain` objects. 
It generates a destinations_str that lists the names and descriptions of all available prompts.
"""
destination_chains = {}
...
router_prompt = PromptTemplate(
    ...
    # input_variables=["user_input", "resume_text", "job_posting"],
...
async def start():
    ...
    cl.user_session.set("llm_chain", multi_chain)
...
async def main(message):
    ...
    if message.content != "help":
        ...
        resume_text = cl.user_session.get("resume_text")
        job_posting = cl.user_session.get("job_posting")
        # user_input = [message.content.strip(), resume_text, job_posting]
        # user_input = {"user_input": message.content.strip(),
        #               "resume_text": resume_text,
        #               "job_posting": job_posting}
        # response = await llm_chain.acall(user_input, 
        #                              callbacks=[
